...
> **版本标签:V1(存档,已被 V2 取代)**
> 本文档是第一版方案(greedy + beam 搜索内核,W0-W5 窗口 ladder,
> instanceId-based `FillerChange`),经算法 review 后已由
> `docs/filler_vt_overlay_repair_spec.md`(V2 定稿)取代,仅作历史参考。
> V2 相对 V1 的差异清单见 V2 spec 末节。

状态:V1 存档。分支:`claude/filler-vt-overlay-repair-plan-2023`。
