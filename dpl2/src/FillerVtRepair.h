...
//
// Where a single-row dirty-gap refill re-tiles one row, FillerVtRepair works on
...
//     min_width in EITHER the horizontal or the vertical direction; otherwise
//     it is a narrow neck (e.g. a 1-wide inter-row staircase) and counts as 1.
...
//   This is a site-grid abstraction; exact foundry polygon DRC is upstream.
#pragma once

#include <string>
#include <vector>

#include "FillerGrid.h"  // Vt, SiteKind, Filler, PlacedFiller, FillerGrid
