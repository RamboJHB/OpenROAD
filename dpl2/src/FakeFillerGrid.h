...
//
// Purpose: drive FillerVtRepair in unit tests without any database, and serve
// as the minimal reference for porting.  To port the repair to a real database,
// implement the FillerGrid interface against that DB the same way this fake
// does -- the FillerVtRepair algorithm does not change.
//
