...
class Grid
{
 public:
  ...
  void initGrid(PhysDesMgr* desMgr,
  ...
  GridY gridHeight(const PhysLibCell& master) const;
 ...
 private:
  ...
  void markHopeless(PhysDesMgr* desMgr,
                    int max_displacement_x,
                    int max_displacement_y);
  void markBlocked(PhysDesMgr* desMgr);
  void visitDbRows(const PhysDesMgr* desMgr,
